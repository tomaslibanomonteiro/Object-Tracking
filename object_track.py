...
from graph_tools.graphs import bbox_rel,draw_boxes

@torch.no_grad()
def detect(weights='yolov5/weights/yolov5s.pt',  # model.pt path(s)
           source='../../Data/team_c_files/20220301-1638-214.mp4',  # file/dir/URL/glob, 0 for webcam
           ...
           config_deepsort="deepsort/configs/deep_sort.yaml"  #Deep Sort configuration
           ):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='../../Data/team_c_files/20220301-1638-214.mp4', help='file/dir/URL/glob, 0 for webcam')
